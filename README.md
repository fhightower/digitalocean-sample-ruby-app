...
[![Deploy to DigitalOcean](https://www.deploytodo.com/do-btn-blue.svg)](https://cloud.digitalocean.com/apps/new?repo=https://github.com/fhighower/digitalocean-sample-ruby-app/tree/main)
...
1. Edit `server.rb` and change the default message, "Set a message by adding ?message=<message here> to the URL"
